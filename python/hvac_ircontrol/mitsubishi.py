...
class Mitsubishi:
    ...
    def __send_command(self, climate_mode, temperature, fan_mode, vanne_vertical_mode, vanne_horizontal_mode, isee_mode, area_mode, start_time, end_time, powerful, power_mode):
        ...
        # RRG old data works for MSZ-FE12NA but not MSY-D36NA
        # Trying new byte data as per instructions https://github.com/r45635/HVAC-IR-Control/issues/26
        ...
        # However this code was using
        # data = [0x23, 0xCB, 0x26, 0x01, 0x00, 0x20,
        #         0x08, 0x06, 0x30, 0x45, 0x67, 0x00,
        #         0x00, 0x00, 0x10, 0x00, 0x00, 0x1F]
        # so not sure if I should change 0x00, 0x00, "0x10", 0x00, 0x00, 0x1F
        #                        to     0x00, 0x00, "0x20", 0x00, 0x00, 0x1F
        # or something else but I will test just changing it to 0x20 
        # 0x20 doesn't work trying 0x30
        data = [0x23, 0xCB, 0x26, 0x01, 0x00, 0x20,
                0x08, 0x06, 0x30, 0x45, 0x67, 0x00,
                0x00, 0x00, 0x20, 0x00, 0x00, 0x1F]
